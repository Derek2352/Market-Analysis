...
def _llm_expand(topic: str, region: str, n: int) -> list[str]:
    ...
    prompt = (
        ...
        f"If the topic contains compound English terms (like AlipayHK, "
        f"HSBCCreditCard, iPhone16), translate or transliterate the components "
        f"into the local language and create mixed-language search queries "
        f"(e.g. '支付寶香港', 'alipay hk usage'). "
